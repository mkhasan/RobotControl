...
public class Joystick extends FrameLayout {
    ...
    private boolean hasFixedRadius = true;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            ...
            Log.e(LOG_TAG, "startOnFirstTouch: "+startOnFirstTouch);
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        Log.e(LOG_TAG, "changed: " + changed + "   Fixed Rad: " + hasFixedRadius);
    ...
    private void recalculateRadius(int width, int height) {
        ...
        Log.e(LOG_TAG, "Stick width: " + stickHalfWidth + " Stick height " + stickHalfHeight);
