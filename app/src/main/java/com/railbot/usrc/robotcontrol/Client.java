...
public class Client extends Thread {
    ...
    static private String TAG = "Client";
    private Socket s;
    ...
    public void run() {
        try {
            ...
            //toServer.w
            try {
                Thread.sleep(100); //wait for the GUI microphone test to release the microphone
            ...
            while (finished == false) { //this infinite cycle checks for new data from the server, then sends it to the correct AudioChannel. if needed, a new AudioChannel is created
                //Log.e(TAG, "working");
